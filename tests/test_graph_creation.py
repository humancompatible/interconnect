...
def test_duplicate_node_names():
    sim = Simulation()
    node1 = Controller(name="C", logic=ControllerLogic())
    node2 = Controller(name="C", logic=ControllerLogic())
...
def test_multiple_inputs_non_aggregator():
    sim = Simulation()
    node1 = Controller(name="C1", logic=ControllerLogic())
    node2 = Controller(name="C2", logic=ControllerLogic())
    node3 = Controller(name="C3", logic=ControllerLogic())
...
def test_no_loop_back_to_checkpoint():
    ...
    node4 = Controller(name="C4", logic=ControllerLogic())
